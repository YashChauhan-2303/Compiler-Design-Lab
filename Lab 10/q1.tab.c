...
const int YY_parse_CLASS::SEMICOLON=261;
const int YY_parse_CLASS::NL=262;
...
#define YYTRANSLATE(x) ((unsigned)(x) <= 262 ? yytranslate[x] : 11)
...
static const char * const yytname[] = {   "$","error","$illegal.","TYPE","ID",
"COMMA","SEMICOLON","NL","stmt","decl","list",""
};
#endif
...
static const short yypact[] = {    -1,
     0,-32768,-32768,    -5,     1,-32768,-32768,     3,     6,-32768
};
