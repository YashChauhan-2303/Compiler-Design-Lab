...
const int YY_parse_CLASS::NL=259;
...
#define YYTRANSLATE(x) ((unsigned)(x) <= 259 ? yytranslate[x] : 11)
...
static const short yyrhs[] = {    10,
     4,     0,    10,     5,    10,     0,    10,     6,    10,     0,
    10,     7,    10,     0,    10,     8,    10,     0,     3,     0
};
...
static const char * const yytname[] = {   "$","error","$illegal.","NUMBER","NL",
"'+'","'-'","'*'","'/'","stmt","exp",""
};
#endif
...
-32768,    -4,-32768,     8,     8,     8,     8,     2,     2,-32768,
-32768,    12,    13,-32768
};
